      ...
      <div className="section" id="about-section">
        ...
        <div id='about-contain'>
          ...
          <p id='about-introduction'>The path to become a Surgeon is very tedious. The journey started from the
            completion of 10th grade where one has to choose the track that will lead him/her
            to be a professional later. Once the 12th grade is completed one has to take up
            the entrance examination (NEET) to gain acceptance into a medical school. After
            the medical school tenure of 5.5 years which often cumulatively becomes 6 years,
            he/she has to take up an entrance examination to gain acceptance into a post
            graduate degree. In this highly competitive world and high demanding society
            ...
            surgical residency easier came from my juniors who works in different part of
            ...
            will give the necessary guide to tackle the struggles by giving a simplified methods
            of technique we use during the training programme in India.
          </p>
        </div>
      </div>
    </>
